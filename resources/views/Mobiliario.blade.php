...
<body>
    ...
    <div class="container">
        <h1 class="text-center text-white mb-4">Gestión de Mobiliario</h1>

        <!-- Botón para abrir el modal -->
        <div class="text-center mb-4">
            <button class="btn btn-primary px-4 py-2" data-bs-toggle="modal" data-bs-target="#addFurnitureModal">Registrar Mobiliario</button>
        </div>

        <!-- Modal para registrar mobiliario -->
        <div class="modal fade" id="addFurnitureModal" tabindex="-1" aria-labelledby="addFurnitureModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addFurnitureModalLabel">Registrar Mobiliario</h5>
