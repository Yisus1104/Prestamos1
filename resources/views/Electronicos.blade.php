...
<body>
    ...
    <div class="container">
        <h1 class="text-center text-white mb-4">Gestión de Electrónicos</h1>

        <!-- Botón para abrir el modal -->
        <div class="text-center mb-4">
            <button class="btn btn-primary px-4 py-2" data-bs-toggle="modal" data-bs-target="#addElectronicsModal">Registrar Producto</button>
        </div>

        <!-- Modal para registrar producto -->
        <div class="modal fade" id="addElectronicsModal" tabindex="-1" aria-labelledby="addElectronicsModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addElectronicsModalLabel">Registrar Producto Electrónico</h5>
